...
class BaseRequest(object):
    ...
    MAX_PARAMS  = 10000 # Für GradeMan erhöht: Nötig für Teilnahmestundechange!
...
def static_file(filename, root, mimetype='auto', download=False):
    ...
    # Für GradeMan auskommentiert: Bilder sollen stets neu geladen werden (wichtig fals geändert)
#    if ims:
